...
function Contact() {
  ...
  return (
    ...
    <div className={contactStyles.firstDiv}>
        ...
        <div className={contactStyles.firstDiv_items123}><a href="https://www.linkedin.com/in/goran-ivankovi%C4%87-86b19b1b9/"> <AiFillLinkedin className='h2' style={{color:"black"}} /> </a> <a href='https://github.com/goranivankovic'><AiFillGithub className='h2' style={{color:"black"}} /></a>  </div>
