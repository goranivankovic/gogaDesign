  ...
  return (
    ...
    <div className={projectStyles.main} id='projekti'>
       ...
       <div className={projectStyles.firstDiv}>
         ...
         <a href='https://react-movie-app-goga.netlify.app/' className={projectStyles.firstDiv_items} >
             <img src={movies} alt="movies" 
               onMouseOver={resize95}
               onMouseLeave={resize100}
               /></a> 

         <a href='https://goran-crypto.vercel.app/' className={projectStyles.firstDiv_items}>
             <img src={crypto} alt="movies" 
               onMouseOver={resize95}
               onMouseLeave={resize100}
              /></a> 

         <a href='https://royal-weather.netlify.app/' className={projectStyles.firstDiv_items}>
             <img src={weather} alt="movies"
               onMouseOver={resize95}
               onMouseLeave={resize100}
               /></a> 

         <a href='https://freedombike.co/' className={projectStyles.firstDiv_items}>
       ...
       <a href='https://goga-login.herokuapp.com/' className={projectStyles.secondDiv_items}>
           <img src={singup} alt="movies" 
            onMouseOver={resize95}
            onMouseLeave={resize100}
             /></a> 

       <a href='http://www.football-api.uk/' className={projectStyles.secondDiv_items}>
           <img src={stadium} alt="movies" 
            onMouseOver={resize95}
            onMouseLeave={resize100}
            /></a> 

       <a href='https://mern-goga.herokuapp.com/' className={projectStyles.secondDiv_items}>
           <img src={coding} alt="movies" 
            onMouseOver={resize95}
            onMouseLeave={resize100}
            /></a> 

      <a href='https://next-js-football-project.vercel.app/' className={projectStyles.secondDiv_items}>
