...
function Navic() {
  ...
  return(
   <div className={navicStyle.main}>
       ...
       <div className={navicStyle.navWidth} id="nawWidth">

       <div className={navicStyle.headlineName}>gogaDesign<FiHexagon className="text-danger" /></div>  
 ...
 {laz ? <FaBars className={navicStyle.bar} onClick={showMenu768} id="bar" /> : <ImCross className={navicStyle.bar} onClick={hideMenu768} id="cros"/>} 
       ...
       <ul>
            <li className="text-warning"><Link to="pocetna"spy={true} smooth={true} hashSpy={true} offset={0} duration={1200} delay={200} isDynamic={true}>{home}</Link></li>
            <li><Link to="services"spy={true} smooth={true} hashSpy={true} offset={0} duration={1200} delay={200} isDynamic={true}>{serv}</Link></li>
            <li><Link to="tehnologija"spy={true} smooth={true} hashSpy={true} offset={0} duration={1200} delay={200} isDynamic={true}>{tech}</Link></li>
            <li><Link to="projekti"spy={true} smooth={true} hashSpy={true} offset={0} duration={1200} isDynamic={true}>{projects}</Link></li>
            <li><Link to="cene"spy={true} smooth={true} hashSpy={true} offset={0} duration={1200} delay={600} isDynamic={true}>{prices}</Link></li>
            <li><Link to="kontakt"spy={true} smooth={true} hashSpy={true} offset={0} duration={1200} delay={600} delay={2000} isDynamic={true}>{contact}</Link></li>
       ...
       <div className={navicStyle.ul768} id="ul">
            ...
            <li><Link to="kontakt"spy={true} smooth={true} hashSpy={true} offset={0} duration={1200} delay={600} delay={2000} isDynamic={true}  onClick={hideMenu768}>{contact}</Link></li>
